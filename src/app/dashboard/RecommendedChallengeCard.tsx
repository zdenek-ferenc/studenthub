...
export default function RecommendedChallengeCard({ challenge }: { challenge: RecommendedChallenge }) {
    ...
    return (
        <Link href={`/challenges/${challenge.id}`} className="group block bg-white p-2 2xl:p-4 rounded-2xl shadow-xs border border-gray-200 hover:shadow-md hover:border-[var(--barva-primarni)] hover:bg-blue-50/50 transition-all duration-300 h-full">

...
import SkillSelector from '../../../../components/SkillSelector'; // <-- Náš nový import
...
export default function StudentRegistrationStep4() {
  ...
  return (
    <div className="flex items-center flex-col py-24 w-2/3 mx-auto bg-white shadow-lg rounded-4xl">
      ...
      <SkillSelector
        onSelectionChange={(ids) => setSelectedSkills(ids)}
      />
      ...
      <button
        onClick={() => alert(`Ukládám dovednosti: ${selectedSkills}`)}
        className="mt-8 px-14 py-4 rounded-3xl font-semibold text-white bg-[var(--barva-primarni)] text-2xl"
      >
        Pokračovat
      </button>
    </div>

  ...
  return (
    <div className='flex flex-col items-center'>
      <input
        ...
        className="px-3 py-1.5 sm:px-4 sm:py-2 text-[var(--barva-primarni)] rounded-2xl font-semibold sm:font-light text-sm sm:text-xl outline-1 transition-colors duration-200 cursor-pointe focus:outline-2 outline-[var(--barva-primarni)]"
      />
